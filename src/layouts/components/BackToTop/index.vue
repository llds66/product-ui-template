...
<template>
  <div v-if="progressNum > 0" class="hidden md:block">
    <div
      class="w-8 h-8 fixed bottom-8 right-5 z-50 rounded-full cursor-pointer flex items-center justify-center"
      :style="{
    ...
    >
      <div class="w-7 h-7 bg-white rounded-full flex items-center justify-center shadow" @click="scrollToTop">
        <div class="i-iconamoon-arrow-up-2-fill text-stone-700 hover:text-stone-950 text-2xl" />
      </div>
    </div>
  </div>
</template>
